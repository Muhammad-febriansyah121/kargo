            ...
            <Table className="shrink-0 ">
                ...
                <TableBody>
                    <TableRow>
                        ...
                        <TableCell>{trx.shipping_order.pickup_type}</TableCell>
                        <TableCell>
                            {new Date(
                ...
                <Table className="shrink-0 border mt-10">
                    ...
                    <TableBody>
                        <TableRow>
                            ...
                            <TableCell>{trx.shipping_order.berat} kg</TableCell>
                        </TableRow>
                        <TableRow>
                            <TableCell className="font-medium">
                                Panjang
                        ...
                        <TableRow>
                            ...
                            <TableCell>{trx.shipping_order.lebar} cm</TableCell>
                        </TableRow>
                        <TableRow>
                            <TableCell className="font-medium">
                                Kota Asal
                        ...
                        <TableRow>
                            ...
                            <TableCell>{trx.shipping_order.status}</TableCell>
                        </TableRow>
                        <TableRow>
                            <TableCell className="font-medium">
                                Tgl Pengiriman
