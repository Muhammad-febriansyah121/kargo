...
use App\Filament\Resources\MitraKamiResource\Pages;
use App\Filament\Resources\MitraKamiResource\RelationManagers;
use App\Models\MitraKami;
use App\Models\User;
use Filament\Forms;
...
class MitraKamiResource extends Resource
{
    ...
    {
        $user = Auth::user();
        if ($user->role === 'admin' && ($user->divisi === null || $user->divisi === "AGENT")) {
            return true;
        }
        return false;
    }
    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                Section::make()->schema([
                    TextInput::make('name')->required()->placeholder('Nama Mitra')->label('Mitra'),
            ...
            ->schema([
                ComponentsSection::make()->schema(
                    [
                        ...
                        TextEntry::make('store')->label('Toko'),
    ...
    {
        return [
            'index' => Pages\ListMitraKamis::route('/'),
            'create' => Pages\CreateMitraKami::route('/create'),
            'edit' => Pages\EditMitraKami::route('/{record}/edit'),
        ];
    }
}
