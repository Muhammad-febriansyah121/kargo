...
class DivisiResource extends Resource
{
    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                Section::make()->schema([
                    TextInput::make('name')->required()->placeholder('Nama'),
                    ...
                    Select::make("divisi")->options([
                        "INCOMING" => "INCOMING",
                        "SANTRI EXPRESS" => "SANTRI EXPRESS",
                        "AGENT" => "AGENT",
                    ])->required(),
                    Select::make('city_id')
                        ->options(
                    ...
                    Select::make('warehouse_id')
                        ->options(fn(Get $get): SupportCollection => WareHouse::query()
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                TextColumn::make('divisi')->label('Divisi')->searchable(),
            ...
            ->schema([
                ComponentsSection::make()->schema(
                    [
                        ...
                        TextEntry::make('divisi')->label('Divisi'),
